...
export const PLANS: Record<Plan, PlanDetails> = {
  ...
  clinic: {
    ...
    price: 97,
    annualPrice: 79,
    description: "Full documentation system for single-location practices",
  ...
  "multi-clinic": {
    ...
    price: 197,
    annualPrice: 159,
    description: "Standardize documentation across every location",
    generationsPerMonth: null,
    maxTeamMembers: 30,
    features: [
