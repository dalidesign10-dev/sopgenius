          ...
          <div className="grid items-center gap-12 lg:grid-cols-2 lg:gap-16">
            ...
            <div>
              ...
              <div className="mt-6 flex flex-wrap items-center gap-x-4 gap-y-2 text-sm text-slate-500">
                <span className="flex items-center gap-1.5"><svg className="h-4 w-4 flex-shrink-0" viewBox="0 0 24 24" fill="none"><rect x="2" y="4" width="20" height="16" rx="2" fill="#1e3a5f"/><rect x="2" y="4" width="20" height="1.23" fill="#B22234"/><rect x="2" y="6.46" width="20" height="1.23" fill="#B22234"/><rect x="2" y="8.92" width="20" height="1.23" fill="#B22234"/><rect x="2" y="11.38" width="20" height="1.23" fill="#B22234"/><rect x="2" y="13.84" width="20" height="1.23" fill="#B22234"/><rect x="2" y="16.31" width="20" height="1.23" fill="#B22234"/><rect x="2" y="18.77" width="20" height="1.23" fill="#B22234"/><rect x="2" y="5.23" width="20" height="1.23" fill="white"/><rect x="2" y="7.69" width="20" height="1.23" fill="white"/><rect x="2" y="10.15" width="20" height="1.23" fill="white"/><rect x="2" y="12.61" width="20" height="1.23" fill="white"/><rect x="2" y="15.08" width="20" height="1.23" fill="white"/><rect x="2" y="17.54" width="20" height="1.23" fill="white"/><rect x="2" y="4" width="9" height="9.23" fill="#3C3B6E"/></svg>Built for U.S. practices</span>
