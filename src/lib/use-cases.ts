...
export const USE_CASES: UseCase[] = [
  {
    ...
    metaTitle: "SOP Generator for Solo Dental Practices — DentiSOP",
    metaDescription:
  ...
  },
  {
    ...
    metaTitle:
      "DSO & Multi-Location Dental SOP Generator — DentiSOP",
    metaDescription:
  ...
  },
  {
    ...
    metaTitle:
      "Dental Compliance SOP Generator — OSHA, HIPAA & CDC Procedures | DentiSOP",
    metaDescription:
  ...
  },
  {
    ...
    metaTitle:
      "Dental Office Manager SOP Generator — Front Office Procedures | DentiSOP",
    metaDescription:
